    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav" style="margin-left: 465px">
                ...
                <li style="margin-top: 7px; margin-left: 20px"><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="white"
                                                                    class="bi bi-person-circle" viewBox="0 0 16 16">
                    <path d="M11 6a3 3 0 1 1-6 0 3 3 0 0 1 6 0z"/>
                    <path fill-rule="evenodd" d="M0 8a8 8 0 1 1 16 0A8
                    8 0 0 1 0 8zm8-7a7 7 0 0 0-5.468 11.37C3.242 11.226 4.805 10 8 10s4.757 1.225 5.468 2.37A7
                    7 0 0 0 8 1z"/>
                </svg></li>
                <li class="nav-item">
...
<div style="width: 1000px; background: #ebd402;margin-left: 50px; padding: 20px; font-size: 20px; font-weight: 600">
    ...
    <div class="form-floating mb-3 col-sm-3 eventInput">
        <form:input path="latitude" type="number" step="0.00000000001" class="form-control" placeholder="Latitude"/>
    ...
    <div class="form-floating mb-3 col-sm-3">
        <form:input path="longitude" type="number" step="0.0000000001" class="form-control" placeholder="Longitude"
    ...
    <div class="form-floating mb-3 col-sm-6 eventInput">
        <form:textarea path="description" type="number" class="form-control" placeholder="Description"
                       style="height: 90px; font-weight: 600"/>
    ...
    <div style="margin-left: 535px"><button style="box-shadow: 1px 1px black; border: 2px solid black;
        font-size: 18px; font-weight: 600; color: white; padding: 3px 35px; background: #037759" class="btn">Create Event</button></div>
</form:form>
</div>
