...
<div class="main-part">
    <h1 class="text-center new-event-underline mb-4">Create a New Sport Event</h1>
        ...
        <form:form action="/new" method="post" modelAttribute="event">
            ...
            <div class="row g-2 mb-3">
                ...
                <c:if test="${nullDateTimeErrorMessage != null}">
                    <div class="text-danger m-1"><c:out value="${nullDateTimeErrorMessage}"></c:out></div>
                </c:if>
                <c:if test="${dateTimeErrorMessage != null}">
                    <div class="text-danger m-1"><c:out value="${dateTimeErrorMessage}"></c:out></div>
                </c:if>
            </div>
