    ...
    <div class="form-register" style="border: 2px solid">
        <%--@elvariable id="user" type="user"--%>
            <form:form action="/account/edit/${user.id}" method="post" modelAttribute="user">
                <h2 class="text-decoration-underline text-center" style="font-weight: 600">Edit User</h2>
                ...
                <div class="d-flex align-content-center">
                    ...
                    <form:input path="birthdate" type="date" class="form-control" value="${user.birthdate}"/>
                </div>
                <div class="d-flex align-content-center"><form:errors path="birthdate" class="text-danger"/></div>

                <button class="btn btn-primary" style="font-size: 18px; color: white; width: 280px; margin-left: 215px">Edit User</button>
            </form:form>
        </div>
</div>
